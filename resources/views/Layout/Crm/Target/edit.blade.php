...
@section('content-page')
    ...
    <div class="col-md-10 content-wrapper">
        <ul class="breadcrumb">
            ...
            <li class="active">Sửa chỉ tiêu</li>
        </ul>
        ...
        <form id="crmTarget" name="crmTarget" method="post"
            action="https://erp.nhanh.vn/crm/target/edit?id=11810">
            <div class="form-horizontal">
                <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="hidden" name="products" id="products" value=""> <select
                                    ...
                                    <option value="220">Maketiing</option>
                                </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-8">
                            <a href="https://erp.nhanh.vn/crm/target/edit?id=11810#" id="btnSubmit"
                                class="btn btn-primary"><i class="fa fa-floppy-o"></i> Lưu</a>
                        </div>
                    </div>
                </fieldset>
            </div>
        ...
        <script>
            ...
            var MESSAGES_NO_QUANTITY = 'Bạn chưa nhập số lượng sản phẩm đăng kí';
