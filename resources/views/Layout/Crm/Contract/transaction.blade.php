...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/firebase-app.j') }}s"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/firebase-messa') }}ging.js"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/firebase-fires') }}tore.js"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/firebase-auth.') }}js"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/getfirebasecon') }}fig"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/notification.j') }}s"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/notification.r') }}educer.js"></script>
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/bootstrap-mult') }}iselect.js"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/saved_resource') }}(2)"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/contract/transaction.js') }}"></script>
@endsection