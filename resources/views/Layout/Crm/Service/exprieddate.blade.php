...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/service/saved_resource(1)') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/service/saved_resource(2)') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/service/saved_resource(3)') }}"></script>
@endsection