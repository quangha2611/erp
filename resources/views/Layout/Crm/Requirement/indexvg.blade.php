                ...
                <div class="col-md-2 lolify-control">
                    <div class="btn-group pull-right lolify-features" data-toggle="tooltip"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="https://erp.nhanh.vn/crm/requirement/indexvg#"
        ...
        <div class="dgContainer">
            <div style="width: 1556px; display: none;" class="stickyHeader">
                <table class="table table-bordered" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr class="even">
                            <th rowspan="2" style="width: 55px;">ID</th>
                            <th rowspan="2" style="width: 77px;">Hợp đồng</th>
                            <th rowspan="2" style="width: 287px;">Khách hàng</th>
                            <th colspan="3" style="width: 363px;">Bên yêu cầu</th>
                            <th colspan="6" style="width: 651px;">Bên thực hiện</th>
                            <th rowspan="2" style="width: 85px;">Trạng thái</th>
                            <th class="col-align-left" title="Thao tác" rowspan="2"
                                style="width: 37px;"><i class="fa fa-cogs icon"></i></th>
                        </tr>
                        <tr>
                            <th style="width: 164px;">Người yêu cầu</th>
                            <th style="width: 111px;">Sản phẩm </th>
                            <th style="width: 88px;">Số tiền </th>
                            <th style="width: 155px;">Người kích hoạt cuối</th>
                            <th style="min-width: 100px; width: 111px;">Thời gian DV </th>
                            <th style="width: 79px;">Số tiền TH </th>
                            <th style="width: 121px;">Phí duy trì (khác)</th>
                            <th style="width: 89px;">Khuyến mại </th>
            ...
            <div class="row">
                ...
                <div class="col-md-6 paginatorItem">
                    <div class="paginator"><span class="labelPages">1 - 30 / 18,888</span><span
                            class="disabled fa fa-step-backward"></span><span
                            class="disabled fa fa-backward"></span><a class="fa fa-forward"
                            href="https://erp.nhanh.vn/crm/requirement/indexvg?page=2"
                            title="Trang sau"></a> <a class="fa fa-step-forward"
                            href="https://erp.nhanh.vn/crm/requirement/indexvg?page=630"
                ...
                <tbody>
                    <tr class="even">
                        ...
                        <td><a href="https://erp.nhanh.vn/crm/account/view?id=6871">Công Ty TNHH Vỏ
                                Xe Vạn ...</a></td>
                        <td><span data-toggle="tooltip" data-title="Phòng KD10"
                                data-original-title="" title="">Nguyễn Hoàng Long</span><br><i
                    ...
                    <tr class="">
                        ...
                        <td><span data-toggle="tooltip" data-title="Phòng KD 01"
                                data-original-title="" title="">Phan Vũ Như Quỳnh</span><br><i
                                class="description text-muted fontsize-85">30/07/2020</i></td>
                        <td>Nạp tiền dự án</td>
                        <td>4.400.000</td>
                        <td><span data-toggle="tooltip"
                                data-title="Phòng chăm sóc khách hàng - Online"
                                data-original-title="" title="">Đào Ngọc Ánh</span></td>
                    ...
                    <tr class="even">
                        <td><a class="text-danger"
                                href="https://erp.nhanh.vn/crm/requirement/viewvg?id=38556">38556</a><br>
                        </td>
                        <td></td>
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/requirement/editvg?id=38556">Sửa</a>
                                    </li>
                                    <li><a class="del_item" data-id="38556">Xóa</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="even">
                        <td><a class="text-danger"
                                href="https://erp.nhanh.vn/crm/requirement/viewvg?id=38521">38521</a><br>
                        </td>
                        <td></td>
                        <td><a href="https://erp.nhanh.vn/crm/account/view?id=9218">PHAN VŨ NHƯ
                                QUỲNH</a></td>
                        <td><span data-toggle="tooltip" data-title="Phòng KD 01">Phan Vũ Như
                                Quỳnh</span><br><i
                                class="description text-muted fontsize-85">23/07/2020</i></td>
                        <td>Nạp tiền</td>
                        <td>1.000.000</td>
                        <td><span data-toggle="tooltip" data-title="Rao vặt - THDV">Nguyễn Nhật
                                Linh</span></td>
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/requirement/editvg?id=38521">Sửa</a>
                                    </li>
                                    <li><a class="del_item" data-id="38521">Xóa</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td><a class="text-danger"
                                href="https://erp.nhanh.vn/crm/requirement/viewvg?id=38518">38518</a><br>
                        </td>
                        <td></td>
                        ...
                        <td><i class="fa fa-check text-success"></i>22/07/2020<br><i
                                class="fa fa-minus-circle text-danger"></i>22/01/2021</td>
                        <td>1.344.000</td>
                        <td></td>
                        <td></td>
                        <td>1.344.000</td>
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/requirement/editvg?id=38518">Sửa</a>
                                    </li>
                                    <li><a class="del_item" data-id="38518">Xóa</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="even">
                        <td><a class="text-danger"
                                href="https://erp.nhanh.vn/crm/requirement/viewvg?id=38495">38495</a><br>
                        </td>
                        <td></td>
                        ...
                        <td><span data-toggle="tooltip" data-title="Rao vặt - THDV">Nguyễn Nhật
                                Linh</span></td>
                        <td><i class="fa fa-check text-success"></i>20/07/2020<br><i
                                class="fa fa-minus-circle text-danger"></i>20/07/2020</td>
                        <td>1.000.000</td>
                        <td></td>
                        <td>50.000</td>
                        <td>1.050.000</td>
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/requirement/editvg?id=38495">Sửa</a>
                                    </li>
                                    <li><a class="del_item" data-id="38495">Xóa</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
