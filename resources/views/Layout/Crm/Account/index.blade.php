...
@section('css')
    <link rel="stylesheet" href="{{ asset('asset/css/crm/account/style.css') }}" type="text/css">
@endsection
...
@section('js')
	...
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/saved_resource') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/firebase-app.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/firebase-messaging.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/firebase-firestore.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/firebase-auth.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/getfirebaseconfig') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/notification.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/notification.reducer.js') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/ckeditor.js') }}"></script>
	<script type="text/javascript">
		CKEDITOR.env.isCompatible = true;
	</script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/saved_resource(1)') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/crm/account/saved_resource(2)') }}"></script>
