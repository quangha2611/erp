...
@section('content-page')
    ...
    btn-success			  col-sm-6">Danh sách cần gọi</a>
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/activity/edit?id=3047677&amp;redirectUri=L2NybS9hY3Rpdml0eS9saXN0Y2FsbD9wYWdlVHlwZT0tMQ==">Sửa</a>
                                    </li>
                    ...
                    <tr class="even">
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/activity/edit?id=3047437&amp;redirectUri=L2NybS9hY3Rpdml0eS9saXN0Y2FsbD9wYWdlVHlwZT0tMQ==">Sửa</a>
                                    </li>
                    ...
                    <tr class="">
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/activity/edit?id=3046554&amp;redirectUri=L2NybS9hY3Rpdml0eS9saXN0Y2FsbD9wYWdlVHlwZT0tMQ==">Sửa</a>
                                    </li>
                    ...
                    <tr class="even">
                        ...
                        <td>
                            <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                ...
                                <ul class="dropdown-menu dropdown-menu-right">
                                    <li><a
                                            href="https://erp.nhanh.vn/crm/activity/edit?id=3044960&amp;redirectUri=L2NybS9hY3Rpdml0eS9saXN0Y2FsbD9wYWdlVHlwZT0tMQ==">Sửa</a>
                                    </li>
