...
@section('css')
    <link href="{{ asset('asset/css/crm/keyword/bootstrap-multiselect.css" media="screen') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('asset/css/crm/keyword/style.css') }}" type="text/css">
@endsection
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/saved_resource') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/firebase-app.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/firebase-messaging.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/firebase-firestore.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/firebase-auth.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/getfirebaseconfig') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/notification.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/notification.reducer.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/keyword/ckeditor.js') }}"></script>
    <script type="text/javascript">
