...
@section('css')
	<link rel="stylesheet" href="{{ asset('asset/css/crm/lead/style.css') }}" type="text/css">
@endsection
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/saved_resource') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/firebase-app.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/firebase-messaging.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/firebase-firestore.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/firebase-auth.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/getfirebaseconfig') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/notification.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/notification.reducer.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/ckeditor.js') }}"></script>
    <script type="text/javascript">
        CKEDITOR.env.isCompatible = true;
    </script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/saved_resource(1)') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/indexvg.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/lead/saved_resource(2)') }}"></script>
@endsection