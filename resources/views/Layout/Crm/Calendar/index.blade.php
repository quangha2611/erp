...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/calendar/fullcalendar.js')}}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/crm/calendar/view.js')}}"></script>
@endsection