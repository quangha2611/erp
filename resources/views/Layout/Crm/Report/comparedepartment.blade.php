...
@section('css')
    ...
    <link rel="stylesheet" href="{{ asset('asset/js/crm/report/css') }}">
    <link id="load-css-0" rel="stylesheet" type="text/css" href="{{ asset('asset/css/crm/report/tooltip.css') }}">
	<link id="load-css-1" rel="stylesheet" type="text/css" href="{{ asset('asset/css/crm/report/util.css') }}">
@endsection
...
@section('js')
    ...
    <script type="text/javascript" charset="UTF-8" src="{{ asset('asset/js/crm/report/dygraph-tickers-combined.js') }}"> </script>
    <script type="text/javascript" charset="UTF-8" src="{{ asset('asset/js/crm/report/webfont.js') }}"></script>
    <script type="text/javascript" charset="UTF-8" src="{{ asset('asset/js/crm/report/jsapi_compiled_bar_module.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('asset/js/crm/report/comparedepartment.js') }}"></script>
@endsection