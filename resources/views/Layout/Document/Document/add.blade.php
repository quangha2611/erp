...
@section('title','ERP-Thêm tài liệu')
    ...
    <div class="col-md-10 content-wrapper">
        ...
        <form method="post" name="documentIndex" class="col-md-12" enctype="multipart/form-data"
            ...
            <div class="form-horizontal">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group"><label class="col-md-4 control-label required">Danh
                            ...
                            <div class="col-md-8"><select name="categoryId" id="categoryId"
                                    ...
                                    <option value="49">SMS marketing</option>
                                    <option value="3516">Sơ đồ phòng ban Nhanh</option>
                                    <option value="3515">Sơ đồ phòng ban</option>
                                    <option value="3520">Mẫu HĐ Nhanh</option>
                                    <option value="4">Đào tạo về sản phẩm</option>
                                    <option value="2">Đào tạo kĩ năng mềm</option>
                                    <option value="53">Video Marketing Tool</option>
                                    <option value="55">Video Hướng dẫn sử dụng Nhanh.vn</option>
                                    <option value="41">Tổng quan Nhanh.vn</option>
                                    <option value="45">Tiếp cận khách hàng - Gọi điện</option>
                                    <option value="46">Tiếp cận khách hàng - Các tài liệu gửi mail
                                    </option>
                                    <option value="52">báo giá dịch vụ</option>
                                    <option value="44">Quy trình làm việc của KD hàng ngày</option>
                                    <option value="3518">Mẫu HĐ</option>
                                    <option value="51">Marketing vatgia</option>
                                    <option value="1">Hướng dẫn sử dụng phần mềm bán hàng</option>
                                    <option value="10">Hướng dẫn sử dụng ERP</option>
                                    <option value="3521">Giấy tờ công ty</option>
                                    <option value="48">Gặp mặt KH - Sale Kit mang đi khi gặp khách
                                        trực tiếp</option>
                                    <option value="47">Gặp mặt KH - Gặp khách</option>
                                    <option value="12">Mẫu hợp đồng</option>
                                    <option value="3517">Biểu mẫu</option>
                                </select></div>
                        </div>
                ...
                <div class="col-md-12">
                    <div>
                        <div class="form-group"><label class="col-md-2 control-label">Nội dung
                                :</label>
                            <div class="col-md-10"><textarea name="content"
                                    class="form-control fullEditor "
                                    style="min-height: 300px; visibility: hidden; display: none;"
                                    id="content"></textarea>
                                <div id="cke_content"
                                    ...
                                    <div class="cke_inner cke_reset" role="presentation"><span
                                        ...
                                        <div id="cke_1_contents" class="cke_contents cke_reset"
                                            role="presentation" style="height: 300px;"><span
                                                id="cke_91" class="cke_voice_label">Nhấn ALT + 0 để
                                                được giúp đỡ</span><iframe
                                                src="./ERP-Thêm tài liệu_files/saved_resource.html"
                        ...
                        <div class="form-group"><label class="col-md-2 control-label">Sau khi lưu dữ
                            ...
                            <div class="col-md-10"><label class="radio radio-inline"><input
                                    ...
                                    tiết tài liệu</label><label class="radio radio-inline"><input
                                        type="radio" value="/document/document/add"
                                        name="afterSubmit">Tiếp tục nhập</label><label
                                    class="radio radio-inline"><input type="radio"
                                        value="/document/document/index" name="afterSubmit">Hiện
        ...
        </form><input type="hidden" id="documentId" value="">
