...
@section('js')
	...
	<script type="text/javascript" src="{{ asset('/asset/js/account/saved_resource(1)') }}"></script>
	<script type="text/javascript" src="{{ asset('/asset/js/account/saved_resource(2)') }}"></script>
