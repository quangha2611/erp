...
@section('css')
    <link href="{{ asset('asset/css/report/bootstrap-multiselect.css') }}" media="screen" rel="stylesheet" type="text/css">
    ...
    <script type="text/javascript" charset="UTF-8" src="{{ asset('asset/js/report/jsapi_compiled_corechart_module.js') }}"></script>
@endsection
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/report/customer.js') }}"></script>
@endsection