...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('asset/js/report/jquery.flot.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/report/jquery.flot.pie.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/report/jquery.flot.categories.js') }}"></script>
    <script type="text/javascript" src="{{ asset('asset/js/report/location.js') }}"></script>
@endsection