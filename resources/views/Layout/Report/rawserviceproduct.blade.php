...
@section('title','ERP-Báo cáo gian hàng theo từng sản phẩm')
...
@section('content-page')
    ...
    <div class="tab-content">
        <ul class="breadcrumb">
            ...
            <li class="active">Báo cáo gian hàng theo sản phẩm</li>
        </ul>
                ...
                <div class="col-md-10 lolify-default">
                    ...
                    <div class="form-group">
                        <input type="text" name="daterangepicker"
                            ...
                            value="01/06/2020 - 30/06/2020"> </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" name="privateName" placeholder="Tên gian hàng"
                            id="privateName" class="form-control" value=""> </div>
                    <div class="form-group">
                        <select name="productId[]" multiple="multiple" id="productId"
                            class="form-control" style="display: none;">
                            <option value="">- Sản phẩm -</option>
                            <optgroup label="Nhanh.vn">
                                <option value="1" selected="selected">Gói Pro - QLBH</option>
                                <option value="103" selected="selected">Gói thiết kế website
                                    theo yêu cầu</option>
                                <option value="107" selected="selected">Dịch vụ vận chuyển
                                </option>
                                <option value="112" selected="selected">Gói phần mềm theo yêu
                                    cầu</option>
                                <option value="125" selected="selected">Phần mềm quản lý doanh
                                    nghiệp ERP</option>
                                <option value="236" selected="selected">Gói thêm tính năng mới
                                </option>
                                <option value="251" selected="selected">Gói Shipping - QLBH
                                </option>
                                <option value="252" selected="selected">Gói Starter - QLBH
                                </option>
                                <option value="253" selected="selected">Gói Premium - QLBH
                                </option>
                                <option value="254" selected="selected">Gói Enterprise - QLBH
                                </option>
                                <option value="261" selected="selected">Gói phí tích hợp API
                                </option>
                                <option value="267" selected="selected">Gói Website cơ bản
                                </option>
                                <option value="268" selected="selected">Gói Website tối ưu
                                </option>
                                <option value="269" selected="selected">Gói Website tiết kiệm
                                </option>
                                <option value="273" selected="selected">Gói website theo yêu cầu
                                </option>
                                <option value="284" selected="selected">Gói Phần mềm quản lý
                                    fanpage</option>
                                <option value="285" selected="selected">Gói Premium Website
                                </option>
                                <option value="293" selected="selected">Gói Basic 1 - QLBH -
                                    online</option>
                                <option value="294" selected="selected">Gói Basic 2 - QLBH -
                                    offline</option>
                                <option value="297" selected="selected">Máy in mã vạch Xprinter
                                    XP 350B</option>
                                <option value="299" selected="selected">Giấy in bill K58
                                </option>
                        ...
                        <div class="btn-group"><button type="button"
                                ...
                                title="Gói Pro - QLBH, Gói thiết kế website theo yêu cầu, Dịch vụ vận chuyển, Gói phần mềm theo yêu cầu, Phần mềm quản lý doanh nghiệp ERP, Gói thêm tính năng mới, Gói Shipping - QLBH, Gói Starter - QLBH, Gói Premium - QLBH, Gói Enterprise - QLBH, Gói phí tích hợp API, Gói Website cơ bản, Gói Website tối ưu, Gói Website tiết kiệm, Gói website theo yêu cầu, Gói Phần mềm quản lý fanpage, Gói Premium Website, Gói Basic 1 - QLBH - online, Gói Basic 2 - QLBH - offline, Máy in mã vạch Xprinter XP 350B, Giấy in bill K58">21
                            ...
                            <ul class="multiselect-container dropdown-menu">
                                ...
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="103">
                                            Gói thiết kế website theo yêu cầu</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="107">
                                            Dịch vụ vận chuyển</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="112">
                                            Gói phần mềm theo yêu cầu</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="125">
                                            Phần mềm quản lý doanh nghiệp ERP</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="236">
                                            Gói thêm tính năng mới</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="251">
                                            Gói Shipping - QLBH</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="252">
                                            Gói Starter - QLBH</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="253">
                                            Gói Premium - QLBH</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="254">
                                            Gói Enterprise - QLBH</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="261">
                                            Gói phí tích hợp API</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="267">
                                            Gói Website cơ bản</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="268">
                                            Gói Website tối ưu</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="269">
                                            Gói Website tiết kiệm</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="273">
                                            Gói website theo yêu cầu</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="284">
                                            Gói Phần mềm quản lý fanpage</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="285">
                                            Gói Premium Website</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="293">
                                            Gói Basic 1 - QLBH - online</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="294">
                                            Gói Basic 2 - QLBH - offline</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="297">
                                            Máy in mã vạch Xprinter XP 350B</label></a></li>
                                <li class="active"><a href="javascript:void(0);"><label
                                            class="checkbox"><input type="checkbox" value="299">
                ...
                <div class="col-md-2 lolify-control">
                    <div class="btn-group pull-right lolify-features" data-toggle="tooltip"
                        ...
                        <ul class="dropdown-menu">
                            <li><a id="exportExcell"
                                    href="https://erp.nhanh.vn/crm/report/contractforservice?daterangepicker=01%2F06%2F2020+-+30%2F06%2F2020&amp;companyId=315&amp;productId%5B%5D=1&amp;productId%5B%5D=103&amp;productId%5B%5D=107&amp;productId%5B%5D=112&amp;productId%5B%5D=125&amp;productId%5B%5D=236&amp;productId%5B%5D=251&amp;productId%5B%5D=252&amp;productId%5B%5D=253&amp;productId%5B%5D=254&amp;productId%5B%5D=261&amp;productId%5B%5D=267&amp;productId%5B%5D=268&amp;productId%5B%5D=269&amp;productId%5B%5D=273&amp;productId%5B%5D=284&amp;productId%5B%5D=285&amp;productId%5B%5D=293&amp;productId%5B%5D=294&amp;productId%5B%5D=297&amp;productId%5B%5D=299&amp;submit=L%E1%BB%8Dc#"><i
        ...
        <div class="dgContainer">
            <div style="width: 2474px;" class="stickyHeader">
                <table class="table table-bordered" cellspacing="0" cellpadding="0">
                    <thead>
                        <tr class="even">
                            <th rowspan="2" style="width: 36px;">STT</th>
                            <th rowspan="2" style="width: 207px;">Tên Gian hàng</th>
                            <th rowspan="2" style="width: 30px;">Số HĐ</th>
                            <th rowspan="2" style="width: 71px;">Tổng giá trị</th>
                            <th rowspan="2" style="width: 71px;">Tổng đã trả</th>
                            <th colspan="2" style="width: 98px;">Gói Pro - QLBH</th>
                            <th colspan="2" style="width: 98px;">Gói thiết kế website theo yêu
                                cầu</th>
                            <th colspan="2" style="width: 98px;">Dịch vụ vận chuyển</th>
                            <th colspan="2" style="width: 98px;">Gói phần mềm theo yêu cầu</th>
                            <th colspan="2" style="width: 98px;">Phần mềm quản lý doanh nghiệp
                                ERP</th>
                            <th colspan="2" style="width: 98px;">Gói thêm tính năng mới</th>
                            <th colspan="2" style="width: 98px;">Gói Shipping - QLBH</th>
                            <th colspan="2" style="width: 98px;">Gói Starter - QLBH</th>
                            <th colspan="2" style="width: 98px;">Gói Premium - QLBH</th>
                            <th colspan="2" style="width: 98px;">Gói Enterprise - QLBH</th>
                            <th colspan="2" style="width: 98px;">Gói phí tích hợp API</th>
                            <th colspan="2" style="width: 98px;">Gói Website cơ bản</th>
                            <th colspan="2" style="width: 98px;">Gói Website tối ưu</th>
                            <th colspan="2" style="width: 98px;">Gói Website tiết kiệm</th>
                            <th colspan="2" style="width: 98px;">Gói website theo yêu cầu</th>
                            <th colspan="2" style="width: 98px;">Gói Phần mềm quản lý fanpage
                            </th>
                            <th colspan="2" style="width: 98px;">Gói Premium Website</th>
                            <th colspan="2" style="width: 98px;">Gói Basic 1 - QLBH - online
                            </th>
                            <th colspan="2" style="width: 98px;">Gói Basic 2 - QLBH - offline
                            </th>
                            <th colspan="2" style="width: 98px;">Máy in mã vạch Xprinter XP 350B
                            </th>
                            <th colspan="2" style="width: 98px;">Giấy in bill K58</th>
                        </tr>
                        <tr>
                            <th style="width: 48px;">Số lượng</th>
                            <th style="width: 50px;">Doanh số</th>
                            <th style="width: 48px;">Số lượng</th>
                            <th style="width: 50px;">Doanh số</th>
                            <th style="width: 48px;">Số lượng</th>
                            <th style="width: 50px;">Doanh số</th>
            ...
            <div class="row">
                ...
                <div class="col-md-6 paginatorItem">
                    <div class="paginator"><span class="labelPages">1 - 22 / 22</span></div>
                </div>
            ...
            <table id="dgCrmReportTarget" class="table table-bordered">
                <thead>
                    <tr class="even">
                        <th rowspan="2">STT</th>
                        <th rowspan="2">Tên Gian hàng</th>
                        <th rowspan="2">Số HĐ</th>
                        <th rowspan="2">Tổng giá trị</th>
                        <th rowspan="2">Tổng đã trả</th>
                        <th colspan="2">Gói Pro - QLBH</th>
                        <th colspan="2">Gói thiết kế website theo yêu cầu</th>
                        <th colspan="2">Dịch vụ vận chuyển</th>
                        <th colspan="2">Gói phần mềm theo yêu cầu</th>
                        <th colspan="2">Phần mềm quản lý doanh nghiệp ERP</th>
                        <th colspan="2">Gói thêm tính năng mới</th>
                        <th colspan="2">Gói Shipping - QLBH</th>
                        <th colspan="2">Gói Starter - QLBH</th>
                        <th colspan="2">Gói Premium - QLBH</th>
                        <th colspan="2">Gói Enterprise - QLBH</th>
                        <th colspan="2">Gói phí tích hợp API</th>
                        <th colspan="2">Gói Website cơ bản</th>
                        <th colspan="2">Gói Website tối ưu</th>
                        <th colspan="2">Gói Website tiết kiệm</th>
                        <th colspan="2">Gói website theo yêu cầu</th>
                        <th colspan="2">Gói Phần mềm quản lý fanpage</th>
                        <th colspan="2">Gói Premium Website</th>
                        <th colspan="2">Gói Basic 1 - QLBH - online</th>
                        <th colspan="2">Gói Basic 2 - QLBH - offline</th>
                        <th colspan="2">Máy in mã vạch Xprinter XP 350B</th>
                        <th colspan="2">Giấy in bill K58</th>
                    </tr>
                    <tr class="">
                        <th>Số lượng</th>
                        <th>Doanh số</th>
                ...
                <tbody>
                    <tr class="even">
                        <td>1</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=1527">sieuthidientucongnghe</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>2</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=7869">hoachatnguyenphongvn</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>3</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=8330">khodienmayhunganh</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>4</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=7935">dogomanhmoc</a>
                        </td>
                        <td>1</td>
                        <td>7,920,000</td>
                        <td>7,920,000</td>
                    ...
                    <tr class="even">
                        <td>5</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=8334">CLEANPROVN</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>6</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=4033">Cananthinh</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>7</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=5575">thietbinhahangkhachsanthienbinh</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>8</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=562">thietbiytehalinh</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>9</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=1783">cophanminhphat</a>
                        </td>
                        <td>1</td>
                        <td>7,920,000</td>
                        <td>7,920,000</td>
                    ...
                    <tr class="">
                        <td>10</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=8290">noithatdungtrang</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>11</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=7702">dogonoithatminhquan</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>12</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=6414">CONGNGHEDUCTIN</a>
                        </td>
                        <td>1</td>
                        <td>7,920,000</td>
                        <td>7,920,000</td>
                    ...
                    <tr class="even">
                        <td>13</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=2169">Thietbihan_Weldtec</a>
                        </td>
                        <td>1</td>
                        <td>7,920,000</td>
                        <td>7,920,000</td>
                    ...
                    <tr class="">
                        <td>14</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=8276">vattudongy</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>15</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=8134">vattuanphu</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="">
                        <td>16</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=707">dienmayvietnamasia</a>
                        </td>
                        <td>1</td>
                        <td>2,544,000</td>
                        <td>2,544,000</td>
                    ...
                    <tr class="even">
                        <td>17</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=6652">dienmayhungthinh</a>
                        </td>
                        <td>1</td>
                        <td>7,920,000</td>
                        <td>7,920,000</td>
                    ...
                    <tr>
                        <td>18</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=1448">kdthienanvietnam</a>
                        </td>
                        <td>1</td>
                        <td>3,960,000</td>
                        <td>3,960,000</td>
                    ...
                    <tr class="even">
                        <td>19</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=6895">dogomynghelamtoi</a>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td>20</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=6672">dalushantools</a>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr class="even">
                        <td>21</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=2201">Anhngocmedical</a>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
                    ...
                    <tr>
                        <td>22</td>
                        <td><a
                                href="https://erp.nhanh.vn/crm/report/detailcontractforservice?daterangepicker=01%2F06%2F2020%20-%2030%2F06%2F2020&amp;serviceId=1814">thietbiyteThanhNhan</a>
                        </td>
                        <td></td>
                        <td></td>
                        <td></td>
