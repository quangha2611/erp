...
@section('title', 'ERP-Sửa khoản mục')
                        ...
                        <fieldset>
                            ...
                            <div class="form-group"><label
                                ...
                                <div class="col-md-8"><input type="text" name="name" maxlength="255"
                                        id="name" class="form-control" value="Tiền đầu kỳ"></div>
                            </div>
                            ...
                            <div class="form-group"><label
                                ...
                                <div class="col-md-8"><input type="text" name="code" maxlength="255"
                                        id="code" class="form-control" value="001"></div>
                            </div><input type="hidden" name="id" id="id" value="164">
                        </fieldset>
                    </div>
