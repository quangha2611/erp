...
@section('content-page')
    ...
    <div class="col-md-10 content-wrapper">
        <ul class="breadcrumb">
            ...
            <li><a href="https://erp.nhanh.vn/accounting/account">Danh sách tài khoản</a></li>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group"><label
                                ...
                                <div class="col-md-8"><input type="text" name="name" maxlength="255"
                                        id="name" class="form-control" value="Tiền chuyển khoản">
                                </div>
                            </div>
                            ...
                            <div class="form-group"><label
                                ...
                                <div class="col-md-8"><input type="text" name="code" maxlength="255"
                                        id="code" class="form-control" value="112"></div>
                            </div>
