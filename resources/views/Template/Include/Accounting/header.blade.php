...
<head>
	...
	<script async="" src="{{ asset("/asset/js/asset/manage/analytics.js") }}"></script>
							...
							<div class="row">
								<div class="col-md-9 topMenu">
									<ul class="nav nav-tabs">
										...
										<li class="active"><a href="https://erp.nhanh.vn/accounting">Kế toán</a></li>
								...
								<div class="col-md-3 topUserBar">
									<div class="top-bar-right">
										...
										<a style="cursor: pointer;color:#fff;float:left;font-size:24px;"
											href="https://erp.nhanh.vn/accounting#mainMenuLeftMobile" id="btMenuMobile"
										...
										<div class="notifications">
											<ul>
												<li class="notification-item general" id="nn-bell">
													<div class="btn-group">
														<a data-toggle="dropdown" class="dropdown-toggle"
															href="https://erp.nhanh.vn/accounting#"> <i
												...
												<li class="notification-item inbox">
													...
													<div class="btn-group">
														<a data-toggle="dropdown" class="dropdown-toggle"
															href="https://erp.nhanh.vn/accounting#"
															aria-expanded="false">
