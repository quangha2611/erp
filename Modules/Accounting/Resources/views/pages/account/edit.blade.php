...
@section('title', 'ERP-Sửa tài khoản kế toán')
...
<div class="col-md-10 content-wrapper">
    <ul class="breadcrumb">
        ...
        <li class="active">Sửa tài khoản kế toán</li>
    </ul>
    <div id="page-idea-add">
        <div class="main-header">
            <h2>Sửa tài khoản kế toán</h2>
            <em>Các trường có dấu * là bắt buộc phải nhập</em>
        </div>
        <form method="post" name="AccountIndex" id="AccountIndex" action="{{ route('post.accounting.account.update') }}">
            @csrf
                        ...
                        <div class="form-group"><label class="col-md-4 control-label">Hình
                            ...
                            <div class="col-md-8"><select name="type" id="type"
                                    ...
                                    @foreach ($types as $type)
                                        @if( $type->id == $currentAccount->type )
