...
use Modules\Accounting\Repositories\Category\CategoryRepository;
use Modules\Accounting\Repositories\Category\CategoryInterfaceRepository;
use Modules\Accounting\Repositories\Fund\FundRepository;
...
class AccountingServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(AccountInterfaceRepository::class,AccountRepository::class);
        $this->app->bind(CategoryInterfaceRepository::class,CategoryRepository::class);
        $this->app->bind(FundInterfaceRepository::class,FundRepository::class);
    }
