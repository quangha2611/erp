...
(function (factory) {
                        ...
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                button = $('<button type="button" class="' + classes.join(' ') + '">' +
                                    innerHtml + '</button>').click(function () {
    ...
    $.extend(Grid.prototype, {
        ...
        headHtml: function () {
            return '' + '<div class="fc-row ' + this.view.widgetHeaderClass + '">' + '<table>' + '<thead>' +
        ...
        headCellHtml: function (row, col, date) {
            ...
            return '' + '<th class="fc-day-header ' + view.widgetHeaderClass + ' fc-' + dayIDs[date.day()] + '">' +
                htmlEscape(calendar.formatDate(date, colFormat)) + '</th>';
        },
    ...
    $.extend(DayGrid.prototype, {
        ...
        highlightSkeletonHtml: function (startCol, endCol) {
            ...
            return '' + '<div class="fc-highlight-skeleton">' + '<table>' + '<tr>' +
                cellHtml + '</tr>' + '</table>' + '</div>';
        }
    });;;
    $.extend(DayGrid.prototype, {
        segs: null,
        ...
        renderSegHtml: function (seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ...
                (isRTL ? titleHtml + ' ' + timeHtml : timeHtml + ' ' + titleHtml) + '</div>' +
                (isResizable ? '<div class="fc-resizer"/>' : '') + '</a>';
        },
    ...
    $.extend(DayGrid.prototype, {
        ...
        renderSegPopoverContent: function (date, segs) {
            ...
            var content = $('<div class="fc-header ' + view.widgetHeaderClass + '">' + '<span class="fc-close ' +
                (isTheme ? 'ui-icon ui-icon-closethick' : 'fc-icon fc-icon-x') + '"></span>' + '<span class="fc-title">' +
                htmlEscape(title) + '</span>' + '<div class="fc-clear"/>' + '</div>' + '<div class="fc-body ' + view.widgetContentClass + '">' + '<div class="fc-event-container"></div>' + '</div>');
    ...
    $.extend(TimeGrid.prototype, {
        ...
        renderHtml: function () {
            return '' + '<div class="fc-bg">' + '<table>' +
                this.rowHtml('slotBg') + '</table>' + '</div>' + '<div class="fc-slats">' + '<table>' +
                this.slatRowHtml() + '</table>' + '</div>';
        },
            ...
            while (slotTime < this.maxTime) {
                ...
                axisHtml = '<td class="fc-axis fc-time ' + view.widgetContentClass + '" ' + view.axisStyleAttr() + '>' +
                    ((!slotNormal || !minutes) ? '<span>' +
                        htmlEscape(calendar.formatDate(slotDate, view.opt('axisFormat'))) + '</span>' : '') + '</td>';
    ...
    $.extend(BasicView.prototype, {
        ...
        renderHtml: function () {
            return '' + '<table>' + '<thead>' + '<tr>' + '<td class="' + this.widgetHeaderClass + '">' +
                this.dayGrid.headHtml() + '</td>' + '</tr>' + '</thead>' + '<tbody>' + '<tr>' + '<td class="' + this.widgetContentClass + '">' + '<div class="fc-day-grid-container">' + '<div class="fc-day-grid"/>' + '</div>' + '</td>' + '</tr>' + '</tbody>' + '</table>';
        },
        headIntroHtml: function () {
            if (this.weekNumbersVisible) {
                return '' + '<th class="fc-week-number ' + this.widgetHeaderClass + '" ' + this.weekNumberStyleAttr() + '>' + '<span>' +
                    htmlEscape(this.opt('weekNumberTitle')) + '</span>' + '</th>';
            }
        },
        numberIntroHtml: function (row) {
            if (this.weekNumbersVisible) {
                return '' + '<td class="fc-week-number" ' + this.weekNumberStyleAttr() + '>' + '<span>' +
                    this.calendar.calculateWeekNumber(this.cellToDate(row, 0)) + '</span>' + '</td>';
            }
        },
        ...
        numberCellHtml: function (row, col, date) {
            ...
            return '' + '<td class="' + classes.join(' ') + '" data-date="' + date.format() + '">' +
                date.date() + '</td>';
        },
    ...
    $.extend(AgendaView.prototype, {
        ...
        renderHtml: function () {
            return '' + '<table>' + '<thead>' + '<tr>' + '<td class="' + this.widgetHeaderClass + '">' +
                ...
                (this.dayGrid ? '<div class="fc-day-grid"/>' + '<hr class="' + this.widgetHeaderClass + '"/>' : '') + '<div class="fc-time-grid-container">' + '<div class="fc-time-grid"/>' + '</div>' + '</td>' + '</tr>' + '</tbody>' + '</table>';
        },
        headIntroHtml: function () {
            var date;
            var weekNumber;
        ...
        dayIntroHtml: function () {
            return '' + '<td class="fc-axis ' + this.widgetContentClass + '" ' + this.axisStyleAttr() + '>' + '<span>' +
