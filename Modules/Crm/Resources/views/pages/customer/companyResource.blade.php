...
@section('title','ERP-Danh sách thông tin nguồn công ty cung cấp')
            ...
            <div class="page-overview" style="margin: 20px 0px;">
                <ul class="nav nav-tabs">
                    <li class="{!! $currentLevel == 0 ? 'active' : '' !!}">
                        <a href="{{ route('get.crm.customer.companyResource') }}">
                    ...
                    @foreach ($customerLevels as $levelParent)
                        @if ($levelParent->parent_id == null)
                            <li class="{!! $currentLevel == $levelParent->id ? 'active' : '' !!}">
                                <a href="{{ route('get.crm.customer.companyResource2',['parentLevel' => $levelParent->id]) }}">
                        ...
                        @foreach ($customers as $customer)
                            <tr class="even">
                                ...
                                <td>
                                    ...
                                    <div class="item-block">
                                        <b>Nguồn: </b>{{ $customer->source->name }}
                                    </div>
                                </td>
