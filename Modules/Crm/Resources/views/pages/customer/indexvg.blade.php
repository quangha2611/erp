...
@section('content-page')
    <div class="col-md-10 content-wrapper">
        <ul class="breadcrumb">
            ...
            <li><a href="https://erp.nhanh.vn/crm/customer/mycustomer">Danh sách khách hàng đang chăm sóc</a></li>
        </ul>
                ...
                @foreach ($customers as $customer)
                    <li class="">
                            ...
                            <div class="col-md-2 pull-right">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <li><a
                                                href="{{ route('get.crm.activity.addPhoneCall', ['id'=>$customer->id]) }}"><i
                                                    class="fa fa-phone"></i> Thêm cuộc gọi</a></li>
                                        <li><a
                                                href="{{ route('get.crm.activity.addMeting', ['id'=>$customer->id]) }}"><i
                                                    class="fa fa-map-marker"></i> Thêm cuộc gặp</a></li>
                                        <li><a
                                                href="{{ route('get.crm.activity.addCalendar', ['id'=>$customer->id]) }}"><i
                                                    class="fa fa-calendar"></i> Thêm lịch hẹn</a></li>
                                        <li><a
                                                href="{{ route('get.crm.activity.addRequestCall', ['id'=>$customer->id]) }}"><i
                        ...
                        <div style="line-height: 25px;padding-bottom:5px;"><i class="fa fa fa-book"
                            ...
                            <lable class="label label-success">{{ $customer->status->name }}</lable>
                        </div>
