                ...
                <div class="col-md-6 dgButtons">
                    <div class="btn-group lolify-features" data-toggle="tooltip"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="{{ route('get.crm.customer.excel') }}"
                    ...
                    @foreach ($customers as $customer)
                        <tr class="">
                            <td><a title="xem chi tiết"
                                    href="https://erp.nhanh.vn/crm/account/view?id=21810">{{ $customer->id }}</a>
                            </td>
                            ...
                            <td class="">
                                <div class="item-block">
                                    ...
                                    <div class="item-infor"><a title="xem chi tiết"
                                            href="https://erp.nhanh.vn/crm/account/view?id=21810">{{ $customer->name }}</a></div>
                                </div>
                                <div class="item-block">
                                ...
                                <div class="item-block opportunityStatus21810" data-toggle="tooltip"
                                    ...
                                    <div class="item-infor"><span class="text text-success">{{ $customer->level->name }}</span>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="dropdown"><a class="fa fa-cogs fa-lg dropdown-toggle"
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li><a
                                                href="{{ route('get.crm.account.edit', ['id' => $customer->id]) }}">Sửa</a>
                                        </li>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('js/crm/account/saved_resource(2)') }}"></script>
@endsection