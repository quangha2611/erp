                            ...
                            <div class="col-md-6" style="padding-top: 35px">
                                <table cellspacing="0" cellpadding="0"
                                    ...
                                    @foreach ($reports as $key => $report)
                                        <tr class="">
                                            <td>{{ $key }}</td>
                                            <td style="text-align: right">{{ number_format($report['totalValue']) }}</td>
                                            <td style="text-align: right">{{ round($report['percentValue']) }}%
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    <tr class="">
                                        ...
                                        <td style="text-align: right">
                                            <strong>{{ number_format($totalAllMoney) }}</strong></td>
                            ...
                            <div class="col-md-6" style="padding-top: 35px">
                                <table cellspacing="0" cellpadding="0"
                                    ...
                                    @foreach ($reports as $key => $report)
                                        <tr class="">
                                            <td> {{ $key }}</td>
                                            <td style="text-align: right">{{ $report['totalContract'] }}</td>
                                            <td style="text-align: right">{{ round($report['percentContract']) }}%
                                            </td>
                                        </tr>
                                    @endforeach
                                    <tr class="">
                                        <td><strong>Tổng</strong></td>
                                        <td style="text-align: right"><strong>{{ $totalAllContract }}</strong>
                                        </td>
                                        <td style="text-align: right"><strong>100%</strong>
                                        </td>
                                    </tr>
...
@section('js')
    ...
    <script type="text/javascript" src="{{ asset('js/crm/report/jquery.flot.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/crm/report/jquery.flot.pie.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/crm/report/jquery.flot.categories.js') }}"></script>
    <script type="text/javascript" src="{{ asset('js/crm/report/location.js') }}"></script>
@endsection