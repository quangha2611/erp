...
<div class="col-md-10 content-wrapper">
    ...
    <form id="activityEdit" name="activityEdit" method="post"
        action="{{ route('post.crm.activity.update',['id'=>$activity->id]) }}"
        enctype="multipart/form-data">
        @csrf
        <div class="form-horizontal">
            <div class="col-md-6">
                <fieldset>
                    <legend>Thông tin hành động: {{ $activity->title }}</legend>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Tiêu đề:</label>
                        <div class="col-md-8">
                            <input type="text" name="title" maxlength="255" id="title"
                                class="form-control" value=" {{ $activity->title }}"> </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea name="content" class="form-control"
                                id="content"> {{ $activity->content }}</textarea> </div>
                    </div>
                </fieldset>
            </div>
                ...
                <fieldset>
                    ...
                    <ul class="accountInfor">
                        ...
                        <li>
                            ...
                            <div class="col-md-8 accountInfor-content">{{ $activity->customer->id }}</div>
                            <div style="clear: both"></div>
                        </li>
                        <li>
                            <div class="col-md-4 ">Tên:</div>
                            <div class="col-md-8 accountInfor-content">{{ $activity->customer->name }}</div>
                            <div style="clear: both"></div>
                        </li>
                        <li>
                            <div class="col-md-4 ">Website:</div>
                            <div class="col-md-8 accountInfor-content">{{ $activity->customer->website }}</div>
                            <div style="clear: both"></div>
                        </li>
                        <li>
                            <div class="col-md-4 ">Phone:</div>
                            <div class="col-md-8 accountInfor-content">
                                {{ $activity->customer->phone }} </div>
                            <div style="clear: both"></div>
                        </li>
                    </ul>
                </fieldset>
