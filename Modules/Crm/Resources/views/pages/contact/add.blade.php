...
@section('title','ERP-Thêm liên hệ')
...
<div class="col-md-10 content-wrapper">
    ...
    <div id="page-crm-contact-add">
        ...
        <form name="crmContact" method="post" id="crmContact" action="{{ route('post.crm.contact.store') }}">
            @csrf
                ...
                <div class="col-md-6">
                    <fieldset>
                        ...
                        <div class="form-group"><label class="col-md-4 control-label">Khách
                                hàng:</label>
                            <div class="col-md-8">
                                <input type="text" name="customer_id" id="customerName"
                                    class="form-control ui-autocomplete-input" value="{{ old('customer_id') }}"
                        ...
                        <div class="form-group"><label
                            ...
                            <div class="col-md-8">
                                <select name="gender" id="gender" class="form-control">
                                    ...
                                    <option value="0" {!! old('gender') == 0 && old('gender') != null? 'selected' : '' !!}>Nữ</option>
                                </select> 
                                @error('gender')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="form-group"><label
                                class="col-md-4 control-label required">Phone:<span
                                    class="required">*</span></label>
                            <div class="col-md-8">
                                <input type="text" name="phone" maxlength="12" id="mobile"
