...
<div class="col-md-10 content-wrapper">
    ...
    <div class="filterContainer">
        <form method="GET" name="crmAccount" class="form-inline" role="form" id="crmAccount" action="{{ route('get.crm.lead.show') }}">
            @csrf
            <div class="form-group">
                <input type="text" name="info_customer" maxlength="200" placeholder="Thông tin khách hàng" id="content" class="form-control" value="{{ old('info_customer') }}">
            </div>
            <div class="form-group">
                <input type="text" name="service_name" maxlength="255" placeholder="Tên gian hàng" id="serviceName" class="form-control" value="{{ old('service_name') }}">
            </div>
            <div class="form-group">
    ...
    @if (isset($customer))
        <div class="container">
                ...
                <ul class="media-list" id="dgCustomer">
                    <li class="">
                        <div>
                            <h4 class="media-heading pull-left row">
                                <a class="customerName customer_58832"
                                    href="https://erp.nhanh.vn/crm/account/view?id=19754">
                                    {{ $customer->name }}
                                </a>
                            </h4>
                        ...
                        <div>
                            ...
                            <a href="https://erp.nhanh.vn/crm/account/view?id=19754"> {{ $customer->phone }}</a>
                        </div>
                        <div>
                            <i class="fa fa-map-marker"></i> {{ $customer->address }} </div>
                            ...
                            <div class="col-md-6 row">
                                ...
                                <div>
                                    @foreach ($customer->users as $user)
                                        <p>
                                            <i class="fa fa-plus"></i> {{ $user->id }} - {{ $user->name }}.
                                            {{-- (<span data-toggle="tooltip" ,="" data-title="Ngày bắt đầu chăm sóc" class="text-info">
                                                <i class="fa fa-clock-o"></i> 10/12/2016 23:03:57
                                            </span>) --}}
                                            <span style="font-size:10px;display: block;font-style: italic;margin-left: 12px;">(Sàn Vật Giá HCM)</span> 
                                        </p>
                                    @endforeach
                                </div>
                            </div>
            ...
            @else
                <h1>Không tìm thấy khách hàng nào</h1>
            @endif
        </div>
    @endif
    <div class="clearfix"></div>
