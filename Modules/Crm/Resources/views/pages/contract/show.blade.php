...
@section('css')
    <link rel="stylesheet" href="{{ asset('css/crm/contract/prettyPhoto.css') }}" type="text/css">
        ...
        <div style="float:right;" class="bt-group">
            <div class="dropdown" style="display: inline-block;">
                ...
                <ul class="dropdown-menu">
                    <li><a
                            href="https://erp.nhanh.vn/crm/contract/addtransaction?contractId=63297">Thêm
                            phiếu thu</a></li>
                    <li><a id="add-requirement-item" data-id="63297"
                            href="https://erp.nhanh.vn/crm/contract/detail?id=63297#"
                            data-toggle="tooltip"
                            data-original-title="Thêm yêu cầu thực hiện dịch vụ">
                            Thêm yêu cầu thực hiện dịch vụ</a></li>
                    <li><a
                            href="https://erp.nhanh.vn/crm/contract/addscheduce?contractId=63297">Thêm
                            lịch hẹn thanh toán</a></li>
                    <li><a class="share-contract-btn"
                            href="https://erp.nhanh.vn/crm/contract/detail?id=63297#"
                            data-link="/crm/contract/detail?id=63297&amp;token=03bb2db3c1876cb08e256dc5a4ff08ef">Lấy
                            link chia sẻ</a></li>
                </ul>

            </div>&nbsp;<a
                href="https://erp.nhanh.vn/crm/contract/loadtemplatecontract?contractId=63297"
                data-toggle="tooltip" data-original-title="In hợp đồng" class="btn btn-default">
                <i class="fa fa-print icon text-info"></i></a>&nbsp;<a id="delete-item"
                data-id="63297" href="https://erp.nhanh.vn/crm/contract/detail?id=63297#"
            ...
            <fieldset style="width:100%;">
                <div class="col-md-6">
                    <legend>Hợp đồng <span style="font-size: 12px;font-style: italic"
                            class="text-success">(<i class="fa fa-check"></i> Đã thanh
                            toán)</span> </legend>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <span> <a href="https://erp.nhanh.vn/crm/contract/detail?id=63297">
                                    63297 </a>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <span>
                                <span class="text-success"><i class="fa fa-check"></i> Đã duyệt
                                </span>
                            </span></div>
                    </div>

                    <div class="form-group">
                        <div class="col-xs-4">Người duyệt:</div>
                        <div class="col-xs-8">
                            <span>
                                <span class="text-info" data-toggle="tooltip"
                                    data-original-title=".2020-07-24 16:28:33.">Nguyễn Thị Tú
                                    Anh</span>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <span>
                                <b>HĐ Marketing (Kí mới)</b>
                            </span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4">Ngành hàng:</div>
                        <div class="col-xs-8"> <b>Thời trang, phụ kiện</b></div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <b>1 tháng</b>
                            <span>
                                (24/07/2020 - <span class="text-danger"><i
                                        class="fa fa-minus-circle"></i>24/08/2020</span>)
                            </span>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <a href="https://erp.nhanh.vn/crm/account/view?id=19130">Nguyễn Đắc
                                Quyết</a>
                            <span class="text-muted">(nguồn: Khách tự liên hệ kinh doanh)</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            Số 6, ngõ 183A,ngách 3 Lĩnh Nam, Hoàng Mai, Hà Nội </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4">
                            CMND:
                        ...
                        <div class="col-xs-8">
                            012949949 - Hà Nội - 20/04/2007 </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-4">
                            Mã số thuế:
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            quyetnguyen1381992@gmail.com </div>
                    </div>
                    ...
                    <div id="customerAdditionalData" class="hide clearfix">
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <b>quyetnguyen1381992@gmail.com</b> </div>
                        </div>
                        <div class="form-group">
                            <div class="col-xs-4">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><span data-toggle="tooltip"
                                            data-title="Ngày hết hạn" class="text-warning"><i
                                                class="fa fa-exclamation-triangle"></i>
                                            24/08/2020</span></td>
                                    <td class="colNb">500.000</td>
                                    <td class="colNb">10%</td>
                                    <td class="colNb"></td>
                                    <td class="colNb"></td>
                                    <td class="colNb">550.000</td>
                                </tr>
                                <tr class="">
                                    <td class="colNb" colspan="9"><b>Tổng: </b></td>
                                    <td class="colNb">550.000</td>
                                </tr>
                            </tbody>
                        </table>
                    ...
                    <div class="col-md-12">
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
                                    <th class="col-align-left">Nhân viên</th>
                                    <th class="col-align-left">Sản phẩm</th>
                                    <th class="col-align-center">Đứng tên</th>
                                    <th class="col-align-right">Doanh số (%)</th>
                                    <th class="col-align-right">Doanh số (VNĐ)</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>9442 - Nguyễn Tiến Đạt - Nhanh.vn | Nhanh HN - Phòng
                                        KD2_TùngNT</td>
                                    <td>Gói Xác minh Maps</td>
                                    <td class="col-align-center">
                                        <i class="fa fa-check-square-o" data-toggle="tooltip"
                                            title="Tính chỉ tiêu sản phẩm cho nhân viên"></i>
                                    </td>
                                    <td class="colNb">90%</td>
                                    <td class="colNb">495.000</td>

                                </tr>
                                <tr>
                                    <td>2</td>
                                    <td>9138 - Chu Văn Thảo - Nhanh.vn | Phòng dịch vụ SEO GG
                                        MAPS</td>
                                    <td>Gói Xác minh Maps</td>
                                    <td class="col-align-center">
                                        <i class="fa fa-check-square-o" data-toggle="tooltip"
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="col-align-center">
                                    <i class="fa fa-arrow-right text-success icon"
                                        data-toggle="tooltip" title="Thu"></i>
                                </td>
                                ...
                                <td class="col-align-center">
                                    <a
                                        href="https://erp.nhanh.vn/crm/contract/viewtransaction?id=76814">Xem
                                        <i class="fa fa-external-link fontsize-85"></i></a>
                                </td>
                                <td class="col-align-center">
                                    Nguyễn Tiến Đạt </td>
                                <td class="col-align-center">
                                ...
                                <td class="col-align-right">
                                    <a
                                        href="https://erp.nhanh.vn/crm/contract/viewtransaction?id=76814">
                                        550.000 </a>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7"><b>Giá trị hợp đồng</b></td>
                                <td class="col-align-right">550.000</td>
                            </tr>
                            <tr>
                                <td colspan="7"><b>Đã trả</b></td>
                                <td class="col-align-right">550.000</td>
                            </tr>
                            <tr>
                                <td colspan="7"><b>Còn lại</b></td>
                ...
                <div class="col-md-12" id="upload-file-content">
                        ...
                        <div class="dgContainer widget-content table-responsive">
                            <div style="display: none; width: 1496px;" class="stickyHeader">
                                <table class="table table-bordered" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr class="even">
                                            <th style="width: 466px;">Thời gian</th>
                                            <th style="width: 442px;">Tạo bởi</th>
                                            <th style="width: 369px;">Loại</th>
                                            <th style="width: 218px;">Thay đổi</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="even">
                                        <td>24/07/2020<span> 17:12:15</span></td>
                                        <td>Nguyễn Thị Hương</td>
                                        <td>Duyệt phiếu thu</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300953" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr>
                                        <td>24/07/2020<span> 17:10:45</span></td>
                                        <td>Nguyễn Tiến Đạt</td>
                                        <td>Tạo phiếu thu</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300951" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr class="even">
                                        <td>24/07/2020<span> 16:28:33</span></td>
                                        <td>Nguyễn Thị Tú Anh</td>
                                        <td>Duyệt HĐ</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300931" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr>
                                        <td>24/07/2020<span> 16:27:08</span></td>
                                        <td>Nguyễn Tiến Đạt</td>
                                        <td>Sửa HĐ</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300929" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr class="even">
                                        <td>24/07/2020<span> 15:13:48</span></td>
                                        <td>Nguyễn Tiến Đạt</td>
                                        <td>Sửa HĐ</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300867" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr>
                                        <td>24/07/2020<span> 15:04:10</span></td>
                                        <td>Nguyễn Tiến Đạt</td>
                                        <td>Sửa HĐ</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300860" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                                    <tr class="even">
                                        <td>24/07/2020<span> 15:03:26</span></td>
                                        <td>Nguyễn Tiến Đạt</td>
                                        <td>Tạo HĐ</td>
                                        <td style="text-align: center"><i
                                                class="fa fa-random showHistory"
                                                style=" cursor: pointer;" data-toggle="tooltip"
                                                data-historyid="300859" data-placement="top"
                                                data-original-title="Xem thay đổi"></i></td>
                                    </tr>
                    ...
                    <div class="col-md-12 group-content">
                        <span>
                            <p>
                                <font color="#444950"><span
                                        style="background-color:rgb(241, 240, 240)">XÁC MINH
                                        MAPS</span></font>
                            </p>

                            <p>Địa chỉ số 3 ngõ 183A lĩnh nam, hoàng mai, hà nội</p>

                            <p><span
                                    style="background-color:rgb(241, 240, 240); color:rgb(68, 73, 80)">0962376583</span>
                            </p>

                            <p>quyetnguyen1381992@gmail.com</p>

                            <p><a
                                    href="https://www.google.com/maps/place/Vincent+Fashion+-+Qu%E1%BA%A7n+%C3%81o+T%E1%BA%B7ng+M%E1%BA%B9/@20.9856055,105.8692466,17z/data=!3m1!4b1!4m5!3m4!1s0x3135adf757667a5f:0x5c317b48aad87342!8m2!3d20.9856055!4d105.8714353?hl=vi-VN">https://www.google.com/maps/place/Vincent+Fashion+-+Qu%E1%BA%A7n+%C3%81o+T%E1%BA%B7ng+M%E1%BA%B9/@20.9856055,105.8692466,17z/data=!3m1!4b1!4m5!3m4!1s0x3135adf757667a5f:0x5c317b48aad87342!8m2!3d20.9856055!4d105.8714353?hl=vi-VN</a>
                            </p>
                        </span>
                    </div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-9" id="commentArea">
                        <div class="comment clearfix" data-id="224772">
                            <div class="avatar-box col-md-2">
                                <div class="col-md-12 user-info">
                                    <div>
                                        <span class="userName">
                                            Nguyễn Tiến Đạt </span>
                                    </div>
                            ...
                            <div class="col-md-10">
                                <div class="content-box ">
                                    ...
                                    <div class="content"><b>Link gia hạn:</b> <a
                                            class="text-danger" target="_blank"
                                            href="https://erp.nhanh.vn/nhiem-vu/gia-han-hop-dong-63297-nguyen-dac-quyet/76846">
                                            erp.nhanh.vn/nhiem-vu/gia-han-hop-dong-63297-nguyen-dac-quyet/76846
                                        </a></div>
                                    <div class="action">
                                    </div>
                                </div>
                                ...
                                <div class="cke_inner cke_reset" role="presentation"><span
                                    ...
                                    <div id="cke_1_contents" class="cke_contents cke_reset"
                                        role="presentation" style="height: 150px;"><span
                                            ...
                                            src="./ERP-Chi tiết hợp đồng-1_files/saved_resource.html"
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 form-horizontal">
                            ...
                            <input id="leadId" type="hidden" value="338710">
                            <input id="accountId" type="hidden" value="19130">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <a id="btnFile" class="btn btn-success"
                                            data-id="63297"><i class="fa fa-upload"></i></a>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <input class="form-control" type="text"
                                            id="showlink-txt"
                                            value=" https://erp.nhanh.vn/crm/contract/detail?id=63297&amp;token=03bb2db3c1876cb08e256dc5a4ff08ef">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="https://erp.nhanh.vn/crm/contract/detail?id=63297"
    ...
    <div id="updateOriginalStatusModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button data-id="63297" type="button"
